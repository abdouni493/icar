  ...
  getAuthHeaders(): Record<string, string> {
    ...
    try {
      ...
      return {
        ...
        'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJtd2d3bWFhcGlvanR3cnVwcnp6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODg1MzUwNTEsImV4cCI6MjEwNDExMTA1MX0.j3rdjtK6h1PonGNIknSnOMwSJRub3FPgi4XOXD_5YNc'
      };
    } catch {
      return {};
    }
